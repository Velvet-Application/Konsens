...
export const metadata:Metadata={title:"Konsens — Entraîne ton intelligence financière",description:"Chaque jour, Konsens entraîne ta capacité à prendre de meilleures décisions avec l’argent : comprendre, prédire, décider et apprendre en Koins fictifs.",applicationName:"Konsens",manifest:"/manifest.webmanifest",icons:{icon:"/konsens-logo.png",apple:"/konsens-logo.png"},other:{"codex-preview":"development","apple-mobile-web-app-capable":"yes","apple-mobile-web-app-title":"Konsens"}};

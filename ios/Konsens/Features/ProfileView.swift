            ...
            VStack(alignment: .leading, spacing: 14) {
                HStack(spacing: 15) {
                    Text(String(store.username.prefix(2)).uppercased())
                        ...
                        .background(LinearGradient(colors: [Color.konsensGreen.opacity(0.2), Color.konsensViolet.opacity(0.18)], startPoint: .topLeading, endPoint: .bottomTrailing), in: Circle())

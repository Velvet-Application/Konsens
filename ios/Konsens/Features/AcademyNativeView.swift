            ...
            HStack(alignment: .center, spacing: 14) {
                ...
                ZStack {
                    ...
                    Image(systemName: "brain.head.profile.fill")
                        ...
                        .foregroundStyle(
                            LinearGradient(colors: [Color.konsensGreen, Color.konsensGold], startPoint: .top, endPoint: .bottom)
                        )
    ...
    var body: some View {
        HStack(alignment: .top, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("Ton score ne récompense pas seulement le gain. Il valorise aussi la compréhension du risque, la régularité et la qualité de tes décisions.")

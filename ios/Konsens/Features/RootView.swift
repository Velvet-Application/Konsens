...
struct RootView: View {
    ...
    var body: some View {
        ...
        .onChange(of: store.isAuthenticated) { _, authenticated in if !authenticated { unlocked=false; biometricAttempted=false; notifications.stop() } }
        .onOpenURL { route($0) }
        .task {
...
private struct FloatingHeader:View{
    ...
    private var universeName:String{switch store.selectedTab{case .play:"PLAY";case .invest:"FINANCE";case .learn:"ACADEMY";case .wealth,.profile:"KONSENS"}}
